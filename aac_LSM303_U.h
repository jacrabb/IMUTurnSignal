...
class aac_LSM303_Accel //: public aac_Sensor
{
  public:
    aac_LSM303_Accel(void);//int32_t sensorID = -1);
...
class aac_LSM303_Mag //: public aac_Sensor
{
  public:
    aac_LSM303_Mag(void);//int32_t sensorID = -1);
