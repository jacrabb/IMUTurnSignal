...
*/
/**************************************************************************/
void aac_LSM303_Accel::write8(byte address, byte reg, byte value)
{
...
*/
/**************************************************************************/
byte aac_LSM303_Accel::read8(byte address, byte reg)
{
  byte value;
...
#define SENSORS_GRAVITY_STANDARD          (SENSORS_GRAVITY_EARTH)
  _accelData.x = _accelData.x * _lsm303Accel_MG_LSB * SENSORS_GRAVITY_STANDARD;
  _accelData.y = _accelData.y * _lsm303Accel_MG_LSB * SENSORS_GRAVITY_STANDARD;
  _accelData.z = _accelData.z * _lsm303Accel_MG_LSB * SENSORS_GRAVITY_STANDARD;
...
/**************************************************************************/
/*!
    @brief  Instantiates a new aac_LSM303 class
*/
/**************************************************************************/
aac_LSM303_Accel::aac_LSM303_Accel() {
  //_sensorID = sensorID;
}
...
/**************************************************************************/
/*
void aac_LSM303_Accel_Unified::getEvent(sensors_event_t *event) {
  /* Clear the event 
...
/**************************************************************************/
/*
void aac_LSM303_Accel_Unified::getSensor(sensor_t *sensor) {
...
*/
/**************************************************************************/
void aac_LSM303_Mag::write8(byte address, byte reg, byte value)
{
  Wire.beginTransmission(address);
  #if ARDUINO >= 100
    Wire.write((uint8_t)reg);
...
*/
/**************************************************************************/
byte aac_LSM303_Mag::read8(byte address, byte reg)
{
  byte value;
...
//            Serial.println("Changing range to +/- 1.9");
  ...
  _magData.x = _magData.x / _lsm303Mag_Gauss_LSB_XY * SENSORS_GAUSS_TO_MICROTESLA;
  _magData.y = _magData.y / _lsm303Mag_Gauss_LSB_XY * SENSORS_GAUSS_TO_MICROTESLA;
  _magData.z = _magData.z / _lsm303Mag_Gauss_LSB_Z * SENSORS_GAUSS_TO_MICROTESLA;
...
*/
/**************************************************************************/
void aac_LSM303_Mag::enableAutoRange(bool enabled)
{
...
*/
/**************************************************************************/
void aac_LSM303_Mag::setMagGain(lsm303MagGain gain)
{
...
/****************************************************************************************************************************************************/
/*
void aac_LSM303_Mag_Unified::getEvent(sensors_event_t *event) {
...
/**************************************************************************/
/*
void aac_LSM303_Mag_Unified::getSensor(sensor_t *sensor) {
  /* Clear the sensor_t object 
  memset(sensor, 0, sizeof(sensor_t));
